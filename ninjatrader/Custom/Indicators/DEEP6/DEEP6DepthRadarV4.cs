// DEEP6 DepthRadar V4 — intent/state-aware JSON Rithmic direct-feed version.
//
// V4 extends V3 with:
//   - intent/state/classification/confidence/duration parsing
//   - intent-based color coding (GEN/SPF/ICE/MIG)
//   - state-based rendering modifiers
//   - enhanced labels + HUD confidence/intent summary
...
{
    public class DEEP6DepthRadarV4 : Indicator
    {
        ...
        protected override void OnStateChange()
        {
            ...
            else if (State == State.DataLoaded)
            {
                ...
                Print("[DEEP6DepthRadarV4] DataLoaded — JSON path: " + WallsJsonPath + " exists=" + File.Exists(WallsJsonPath));
            }
            ...
            {
                Print("[DEEP6DepthRadarV4] Realtime — reading Rithmic DOM data from JSON: " + WallsJsonPath);
            }
        ...
        private void OnJsonCheck(object state)
        {
            ...
            {
                Print("[DEEP6DepthRadarV4] JSON read failed: " + ex.Message);
            }
        }
        ...
        private bool ReadWallsFromJson()
        {
            ...
            if (updated)
            {
                ...
                Print(string.Format("[DEEP6DepthRadarV4] JSON loaded {0} bids + {1} asks (WallMinSize={2})",
        ...
        private void DrawHud(RenderSummary summary)
        {
            ...
            string text = string.Format(
                "DEPTH RADAR V4 [JSON] | vis B:{0} A:{1} | loaded B:{2} A:{3} | GEN:{4} SPF:{5} ICE:{6} MIG:{7} | avg conf:{8:0}% | reads:{9}",
        ...
        [NinjaScriptProperty]
        [Display(Name = "Color By Intent", Order = 1, GroupName = "Depth Radar V4")]
        public bool ColorByIntent { get; set; }

        [NinjaScriptProperty]
        [Display(Name = "Show Confidence", Order = 2, GroupName = "Depth Radar V4")]
        public bool ShowConfidence { get; set; }

        [NinjaScriptProperty]
        [Display(Name = "Show State Markers", Order = 3, GroupName = "Depth Radar V4")]
