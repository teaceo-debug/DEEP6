...
//   %USERPROFILE%\Documents\NinjaTrader 8\bin\Custom\Indicators\DEEP6\DEEP6FootprintV3.cs
...
{
    public class DEEP6FootprintV3 : Indicator
    {
        // ---- State ----
        ...
        protected override void OnStateChange()
        {
            ...
            {
                Description         = "DEEP6 Footprint V3 — separate Version Three footprint path with setup, direction, and trigger visuals only.";
                Name                = "DEEP6 Footprint V3";
        ...
        private void DrawScorerTierMarker(int barIdx, ScorerResult scored)
        {
            ...
            // V3: restore the old gray setup marker first, then promote to armed/triggered visuals.
            // Setup = gray context marker only. Armed = WAIT LONG/WAIT SHORT. Triggered = separate trigger marker path.
...
namespace NinjaTrader.NinjaScript.Indicators
{
    ...
    {
        private DEEP6.DEEP6FootprintV3[] cacheDEEP6FootprintV3;
        public DEEP6.DEEP6FootprintV3 DEEP6FootprintV3(double imbalanceRatio, double absorbWickMinPct, double exhaustWickMinPct, bool showFootprintCells, bool showPoc, bool showValueArea, bool showAbsorptionMarkers, bool showExhaustionMarkers, float cellFontSize, int cellColumnWidth, bool showProfileAnchors, bool showPriorDayLevels, bool showNakedPocs, bool showCompositeVA, int nakedPocMaxAgeSessions, bool showLiquidityWalls, int liquidityWallMin, int liquidityWallStaleSec, int liquidityMaxPerSide, bool showChartTrader)
        {
            return DEEP6FootprintV3(Input, imbalanceRatio, absorbWickMinPct, exhaustWickMinPct, showFootprintCells, showPoc, showValueArea, showAbsorptionMarkers, showExhaustionMarkers, cellFontSize, cellColumnWidth, showProfileAnchors, showPriorDayLevels, showNakedPocs, showCompositeVA, nakedPocMaxAgeSessions, showLiquidityWalls, liquidityWallMin, liquidityWallStaleSec, liquidityMaxPerSide, showChartTrader);
        }

        public DEEP6.DEEP6FootprintV3 DEEP6FootprintV3(ISeries<double> input, double imbalanceRatio, double absorbWickMinPct, double exhaustWickMinPct, bool showFootprintCells, bool showPoc, bool showValueArea, bool showAbsorptionMarkers, bool showExhaustionMarkers, float cellFontSize, int cellColumnWidth, bool showProfileAnchors, bool showPriorDayLevels, bool showNakedPocs, bool showCompositeVA, int nakedPocMaxAgeSessions, bool showLiquidityWalls, int liquidityWallMin, int liquidityWallStaleSec, int liquidityMaxPerSide, bool showChartTrader)
        {
            if (cacheDEEP6FootprintV3 != null)
                for (int idx = 0; idx < cacheDEEP6FootprintV3.Length; idx++)
                    if (cacheDEEP6FootprintV3[idx] != null && cacheDEEP6FootprintV3[idx].ImbalanceRatio == imbalanceRatio && cacheDEEP6FootprintV3[idx].AbsorbWickMinPct == absorbWickMinPct && cacheDEEP6FootprintV3[idx].ExhaustWickMinPct == exhaustWickMinPct && cacheDEEP6FootprintV3[idx].ShowFootprintCells == showFootprintCells && cacheDEEP6FootprintV3[idx].ShowPoc == showPoc && cacheDEEP6FootprintV3[idx].ShowValueArea == showValueArea && cacheDEEP6FootprintV3[idx].ShowAbsorptionMarkers == showAbsorptionMarkers && cacheDEEP6FootprintV3[idx].ShowExhaustionMarkers == showExhaustionMarkers && cacheDEEP6FootprintV3[idx].CellFontSize == cellFontSize && cacheDEEP6FootprintV3[idx].CellColumnWidth == cellColumnWidth && cacheDEEP6FootprintV3[idx].ShowProfileAnchors == showProfileAnchors && cacheDEEP6FootprintV3[idx].ShowPriorDayLevels == showPriorDayLevels && cacheDEEP6FootprintV3[idx].ShowNakedPocs == showNakedPocs && cacheDEEP6FootprintV3[idx].ShowCompositeVA == showCompositeVA && cacheDEEP6FootprintV3[idx].NakedPocMaxAgeSessions == nakedPocMaxAgeSessions && cacheDEEP6FootprintV3[idx].ShowLiquidityWalls == showLiquidityWalls && cacheDEEP6FootprintV3[idx].LiquidityWallMin == liquidityWallMin && cacheDEEP6FootprintV3[idx].LiquidityWallStaleSec == liquidityWallStaleSec && cacheDEEP6FootprintV3[idx].LiquidityMaxPerSide == liquidityMaxPerSide && cacheDEEP6FootprintV3[idx].ShowChartTrader == showChartTrader && cacheDEEP6FootprintV3[idx].EqualsInput(input))
                        return cacheDEEP6FootprintV3[idx];
            return CacheIndicator<DEEP6.DEEP6FootprintV3>(new DEEP6.DEEP6FootprintV3() { ImbalanceRatio = imbalanceRatio, AbsorbWickMinPct = absorbWickMinPct, ExhaustWickMinPct = exhaustWickMinPct, ShowFootprintCells = showFootprintCells, ShowPoc = showPoc, ShowValueArea = showValueArea, ShowAbsorptionMarkers = showAbsorptionMarkers, ShowExhaustionMarkers = showExhaustionMarkers, CellFontSize = cellFontSize, CellColumnWidth = cellColumnWidth, ShowProfileAnchors = showProfileAnchors, ShowPriorDayLevels = showPriorDayLevels, ShowNakedPocs = showNakedPocs, ShowCompositeVA = showCompositeVA, NakedPocMaxAgeSessions = nakedPocMaxAgeSessions, ShowLiquidityWalls = showLiquidityWalls, LiquidityWallMin = liquidityWallMin, LiquidityWallStaleSec = liquidityWallStaleSec, LiquidityMaxPerSide = liquidityMaxPerSide, ShowChartTrader = showChartTrader }, input, ref cacheDEEP6FootprintV3);
        }
    }
}
...
namespace NinjaTrader.NinjaScript.MarketAnalyzerColumns
{
    ...
    {
        public Indicators.DEEP6.DEEP6FootprintV3 DEEP6FootprintV3(double imbalanceRatio, double absorbWickMinPct, double exhaustWickMinPct, bool showFootprintCells, bool showPoc, bool showValueArea, bool showAbsorptionMarkers, bool showExhaustionMarkers, float cellFontSize, int cellColumnWidth, bool showProfileAnchors, bool showPriorDayLevels, bool showNakedPocs, bool showCompositeVA, int nakedPocMaxAgeSessions, bool showLiquidityWalls, int liquidityWallMin, int liquidityWallStaleSec, int liquidityMaxPerSide, bool showChartTrader)
        {
            return indicator.DEEP6FootprintV3(Input, imbalanceRatio, absorbWickMinPct, exhaustWickMinPct, showFootprintCells, showPoc, showValueArea, showAbsorptionMarkers, showExhaustionMarkers, cellFontSize, cellColumnWidth, showProfileAnchors, showPriorDayLevels, showNakedPocs, showCompositeVA, nakedPocMaxAgeSessions, showLiquidityWalls, liquidityWallMin, liquidityWallStaleSec, liquidityMaxPerSide, showChartTrader);
        }

        public Indicators.DEEP6.DEEP6FootprintV3 DEEP6FootprintV3(ISeries<double> input, double imbalanceRatio, double absorbWickMinPct, double exhaustWickMinPct, bool showFootprintCells, bool showPoc, bool showValueArea, bool showAbsorptionMarkers, bool showExhaustionMarkers, float cellFontSize, int cellColumnWidth, bool showProfileAnchors, bool showPriorDayLevels, bool showNakedPocs, bool showCompositeVA, int nakedPocMaxAgeSessions, bool showLiquidityWalls, int liquidityWallMin, int liquidityWallStaleSec, int liquidityMaxPerSide, bool showChartTrader)
        {
            return indicator.DEEP6FootprintV3(input, imbalanceRatio, absorbWickMinPct, exhaustWickMinPct, showFootprintCells, showPoc, showValueArea, showAbsorptionMarkers, showExhaustionMarkers, cellFontSize, cellColumnWidth, showProfileAnchors, showPriorDayLevels, showNakedPocs, showCompositeVA, nakedPocMaxAgeSessions, showLiquidityWalls, liquidityWallMin, liquidityWallStaleSec, liquidityMaxPerSide, showChartTrader);
        }
    }
