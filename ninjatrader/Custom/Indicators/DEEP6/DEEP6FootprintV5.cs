// DEEP6 Footprint V5 — NinjaTrader 8 indicator.
//
...
//   %USERPROFILE%\Documents\NinjaTrader 8\bin\Custom\Indicators\DEEP6\DEEP6FootprintV5.cs
...
{
    public class DEEP6FootprintV5 : Indicator
    {
        // ---- State ----
        ...
        protected override void OnStateChange()
        {
            ...
            {
                Description         = "DEEP6 Footprint V5 — per-bar footprint with absorption/exhaustion markers, POC/VA, and profile anchor levels.";
                Name                = "DEEP6 Footprint V5";
            ...
            for (int barIdx = fromIdx; barIdx <= toIdx; barIdx++)
            {
                ...
                if (ShowFootprintCells)
                {
                    foreach (var kv in fbar.Levels)
                    {
                        ...
                        // V5 intentionally removes the per-cell bid/ask number text from V1.
