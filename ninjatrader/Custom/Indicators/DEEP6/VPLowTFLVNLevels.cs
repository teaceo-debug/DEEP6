...
//
// Builds a monthly volume profile from lower-timeframe (default: 1-min) bars
// and marks Low Volume Node price levels as horizontal lines on the chart.
// Bull color = LVN is overhead (price below); Bear color = LVN is support (price above).
// Lowest-volume LVN gets a solid line; all others are dashed. Resets each calendar month.
//
// Install: copy to
...
namespace NinjaTrader.NinjaScript.Indicators
{
    public class VPLowTFLVNLevels : Indicator
    {
        ...
        protected override void OnStateChange()
        {
            ...
            {
                Description      = "Volume Profile LVN — monthly profile from 1-min bars; marks low-volume node levels as horizontal lines";
                Name             = "VP LowTF LVN";
        ...
        protected override void OnBarUpdate()
        {
            ...
            int periodKey = Time[0].Year * 12 + Time[0].Month;
