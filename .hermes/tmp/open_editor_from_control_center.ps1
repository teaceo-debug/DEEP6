...
[WinCtl]::ShowWindow($cc.MainWindowHandle, 9) | Out-Null
Start-Sleep -Milliseconds 200
[WinCtl]::MoveWindow($cc.MainWindowHandle, 100, 100, 1200, 800, $true) | Out-Null
Start-Sleep -Milliseconds 200
[WinCtl]::SetForegroundWindow($cc.MainWindowHandle) | Out-Null
